...
interface SimplePipelineMonitorProps {
  isDarkMode: boolean;
}

const SimplePipelineMonitor: React.FC<SimplePipelineMonitorProps> = ({ isDarkMode }) => {
  ...
  const fetchPipelineStatus = async () => {
    try {
      ...
      setPipelines([
        ...
        {
          id: '3',
          name: 'Dataset Transformation Pipeline',
          status: 'pending',
          stage: 'Queue',
          progress: 0,
        ...
        <div className="p-6">
          {error ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Showing demo data</p>
            </div>
          ) : null}
...
export default SimplePipelineMonitor;